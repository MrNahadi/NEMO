...
\section{Structural Optimization as a Constrained Search}
...
\section{The Nelder--Mead Simplex Method}
...
\section{Variable Scaling, Bounds, and Constraint Penalties}
...
\section{Simulation Intent and Semantic Boundary Roles}
...
\section{Marine Structural Optimization}
...
\section{Bracket Structural Behavior}
...
\section{Padeyes and Pinned Connections}
...
\section{Stabilizer Fins and Prescribed Hydrodynamic Loads}
...
\section{Linear Static Finite Element Analysis}
...
\section{Verification, Validation, and Model Credibility}
\label{sec:vv-review}
